  ...
  <h2 class="text-3xl font-semibold text-purple-800 text-center mb-6 mt-10">
    ...
    <form method="POST" id="protectedForm" action="./controllers/procesar_ingreso.php" class="space-y-6">
      ...
      <button 
        ...
        type="submit" 
        type="submit" 
        class="w-full g-recaptcha bg-gradient-to-r from-purple-600 to-pink-500 text-white py-3 rounded-full font-semibold hover:from-purple-700 hover:to-pink-600 transition duration-300 flex items-center justify-center shadow-lg transform hover:scale-105"
      >

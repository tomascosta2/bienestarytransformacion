...
$sql = "SELECT vcg.id, vcg.ruta_video FROM videos_curso_destacados vcg WHERE vcg.curso_id = ?";
...
<div class="max-w-6xl xl:max-w-7xl mx-auto mt-10 p-5">
    ...
    <div class="overflow-x-auto">
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr class="hover:bg-gray-200 transition duration-200">
                            ...
                            <td class="py-3 px-4 border">
                                ...
                                <form action="./controllers/delete_video_destacado.php" method="POST" class="inline-block">
        ...
        <div class="mt-6 text-center">
            <a href="./?page=agregar_video_destacados&curso_id=<?php echo $curso_id; ?>" class="bg-purple-600 text-white py-2 px-6 rounded hover:bg-purple-700">Agregar Videos</a>
        </div>
    </div>
</div>
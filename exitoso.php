...
<body class="flex items-center justify-center h-screen bg-gradient-to-r from-purple-200 via-pink-100 to-purple-200">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md text-center">
        <h2 class="text-3xl font-semibold text-purple-800 mb-6">¡Registro Exitoso!</h2>
        <p class="text-gray-600 mb-6">
            Hemos enviado un correo electrónico al email que proporcionaste. 
